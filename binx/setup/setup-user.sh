...
DEB_DEV_PKG1="python-pip silversearcher-ag silversearcher-ag-el s-el ack-grep doxygen doxymacs libjson-glib-dev cmake uncrustify pasystray spacefm-gtk3 thunar pcmanfm xfce4-powermanager xfce4-notifyd "
