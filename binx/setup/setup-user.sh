...
DEB_EXTRA_PKG_COMMUNICATION="pidgin pidgin-skype pidgin-skypeweb empathy empathy-skype purple-skypeweb telegram-purple pidgin-plugin-pack bitlbee-libpurple bitlbee-plugin-otr tor" #  bitlbee
...
DEB_PKG2_TOOL_GUI="unclutter xscreensaver xscreensaver-gl xss-lock wmmatrix rss-glx  xssproxy xscreensaver-data-extra xscreensaver-gl-extra" # event
