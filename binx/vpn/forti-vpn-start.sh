...
sshpass -p$PASSWD /opt/forticlient-sslvpn/64bit/forticlientsslvpn_cli forticlientsslvpn_cli --vpnuser $FORTI_VPN_USER --server $FORTI_VPN_SERVER:$FORTI_VPN_PORT
