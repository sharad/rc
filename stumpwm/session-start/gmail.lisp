;; ;; This is the code that I use to put a "gmail notifier"-style
;; ;; indicator in my mode-line. It requires the XMLS and DRAKMA
;; ;; packages; both of these packages are pretty straightforward to
