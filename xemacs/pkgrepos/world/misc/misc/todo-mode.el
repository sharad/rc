...
;;             e-mail reply from Trey Jackson <tr...@cs.berkeley.edu> who
...
;; $Log: todo-mode.el,v $
;; Revision 1.21  1997/10/18  13:31:40  os10000
;; Rafael Laboissiere <raf...@icp.inpg.fr> writes:
;;
...
;; Thanks to Harald Backer <harald...@fou.telenor.no>, we now have
...
;; Jari Aalto <jari....@poboxes.com> writes:
;;
...
;; Harald Meland <harald...@usit.uio.no> asked for
...
;; Applied patch from Istvan Marko <ist...@cmdmail.amd.com>
;; to make menus work anywhere.
;;
;; Revision 1.10  1997/08/06  08:56:03  os10000
;; Acted upon suggestion from Shane Holder <hol...@rsn.hp.com>:
...
;; tutorial: http://groups.google.com/group/gnu.emacs.help/browse_thread/thread/6d55768f621067c6/cec507b4c628b776?pli=1

;; https://groups.google.com/forum/?fromgroups=#!msg/gnu.emacs.sources/7v7Wlnocr8o/bSUKTMEdL4QJ
;;  	Post reply
;; More message actions
;; 18/10/1997
;; todo-mode.el revision 1.21

;; Hello Everybody!

;; Thanks to Rafael Laboissiere, we now have the ability to give the NEXT
;; function a prefix argument, to skip several entries, and to have the
;; insertion algorithm insert an entry under the cursor by simply
;; pressing C-u before the 'i' command.

;; I hope that helps,

;; Oliver Seidel

;; PS: If anybody thinks I'm getting carried away with posting the same
;; thing over and over again, please let me know and I'll stop.  I do
;; realise that the modifications are quite minor.
