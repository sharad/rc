;;; $Id: mousymacro.el,v 1.15 2004/07/11 16:27:55 queinnec Exp $
;;; Copyright (C) 1994-2004 by C.Queinnec (University of Paris 6)

;;; LCD Archive Entry:
;;; mousymacro|Christian Queinnec|Christian.Queinnec@lip6.fr|
;;; Run macros via simple mouse clicks.|
;;; $Date: 2004/07/11 16:27:55 $|$Revision: 1.15 $|
...
;;; on  http://www-spi.lip6.fr/~queinnec/Miscellaneous/mousymacro.el
...
(if (and window-system 
         ...
         (>= (car (read-from-string emacs-version 
                                    ...
                                    (match-end 1) ))
             19.21 ) )
    ;; Adapted to Emacs 20.7 on 19 XI 2001.
    nil ; this is OK
...
;;; Needed for the x-pointer-pencil variable (value is 86).
;;;(load-library "term/x-win")
;;; 2004 july 10: the previous library is no longer needed for Emacs 21.3.1

(defvar mm-default-cursor 
  (if (eq window-system 'x)
      x-pointer-pencil
    86 ) ; 86 is the value of x-pointer-pencil in x-win.el
...
\\{mm-map}
Complaints or comments should be emailed to Christian.Queinnec@lip6.fr  "
  (interactive "")
...
(defun mm-funny-echo-word (event)
  (interactive "e")
  (save-excursion
