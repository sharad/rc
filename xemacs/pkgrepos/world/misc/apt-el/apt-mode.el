...
Special commands: \\{apt-mode-map}
  Turning on `apt-mode' runs the hook `dpkg-l-mode-hook'."
  (interactive)
...
(defvar apt-dpkg-l-width "120" "*The COLUMN variable for dpkg -l.")
(defun apt-dpkg-l ()
