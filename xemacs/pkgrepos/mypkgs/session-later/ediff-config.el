...
(defun configuration|common|ediff-config|init ()
  (configuration|common|ediff-config|config))
;; (push 'LIB1 configuration|common|ediff-config|package-list)
;;;###autoload
(defun configuration|common|ediff-config|packages ()
  configuration|common|ediff-config|package-list)
