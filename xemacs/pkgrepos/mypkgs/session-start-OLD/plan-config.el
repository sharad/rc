...
(when (file-directory-p (expand-file-name "web/site/wiki/Organize/plan/Plans" *muse-top-dir*))
  (deh-require-maybe (and muse-config publishing-config planner)
    ...
    ;; Setting up Planner
    ;; Add the files to your load-path. Change these paths as needed.
    (setq planner-directory (expand-file-name "web/site/wiki/Organize/plan/Plans" *muse-top-dir*))
