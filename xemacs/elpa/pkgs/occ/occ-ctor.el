...
(cl-defmethod occ-collection-included-files ((collection occ-included-files-tsk-collection))
  (unless (occ-included-files-tsk-collection-included-files occ-global-tsk-collection)
    (occ-collect-tsks occ-global-tsk-collection nil))
  (occ-included-files-tsk-collection-included-files occ-global-tsk-collection))
