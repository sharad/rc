...
*** Root dir property of task
    #+begin_src elisp
      ...
      (cl-defmethod occ-rankprop-with ((obj occ-tsk)
        ...
        (occ-message "rankprop-with(%s, %s, %s): begin"
                     (occ-format obj 'capitalize)
        ...
        (let* ((tsk-root (occ-get-property obj prop))
          ...
          (if tsk-root
              (progn
                (occ-message "tsk %s tsk-root: %s" (occ-format obj 'capitalize) tsk-root)
                (occ-message "tsk %s ctx-dir:  %s" (occ-format obj 'capitalize) ctx-dir))
            (occ-message "tsk %s tsk-root %s not present."
