             ...
             (opt
              (cdr
               (assoc
                ...
                options)))
             (timelen
              (let ((default (org-rl-get-time-gap)))
               (if (or (zerop default)
                       (memq opt
                             '(done
                               cancel-next-p
             ...
             (let ((other-marker
               ...
               (if (> timelen 0)
                   ...
                   (let* ((other-stop-time
                          ...
                          (other-clock
                           (list other-marker (org-rl-clock-start-time next) other-stop-time)))
...
;;;###autoload
(defun org-clock-resolve-clocks (clocks)
  (let ((next (pop clocks))
        (prev (pop clocks)))
