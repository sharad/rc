;;; org-activity-capture-note.el --- Emacs Activity logger, analyzer and reporter  -*- lexical-binding: t; -*-
...
(defsubclass-gen@ @note-class :gen-org-log-note (marker)
...
;;; org-activity-capture-note.el ends here
