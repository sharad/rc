...
***** BUG org-resolve-clock-idle is not getting called
***** BUG org-clock-in-if-not should be removed from after-make-frame-functions when no frame left it should not count make-reader-frame
...
***** STARTED Resolve Idle clock should provide options to clock other task that is with amount of time idle.
      ...
      :END:
      :LOGBOOK:
      CLOCK: [2017-12-08 Fri 17:41]
      CLOCK: [2017-12-08 Fri 17:40]
