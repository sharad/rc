...
***** CLOSED BUG org-resolve-clock-idle is not getting called
      ...
      :END:
***** org-resolve-idle appear many time when idle for multiples of 5 mins
***** correct org-clock-resolve-idle default time is coming more than thousands
***** correct log-not-on-change not working properly
...
***** correct org-context-clock-add-context-to-org-heading-when-idle
