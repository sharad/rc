...
***** Add Unnamed task no context match and no manually clocked in task present. :concept:
****** Detection when a New Unnamed task should be created or one of Previous Unnamed tasks should be used will have many details.
****** These should be prompted to be  renamed and refiled later to correct task
