...
**** org-clock-in-if-not should be removed from after-make-frame-functions when no frame left it should not count make-reader-frame
...
**** Interface to add new task which should provide options
