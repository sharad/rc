...
**** BUGS
***** cleanup lotus-timer-utils timer not working properly and unable to cancel them.
...
***** CLOSED BUG org-resolve-clock-idle is not getting called
      ...
      :END:
***** DONE org-resolve-idle appear many time when idle for multiples of 5 mins
      CLOSED: [2017-12-15 Fri 23:08]
      :LOGBOOK:
      - State "DONE"       from              [2017-12-15 Fri 23:08] \\
        Guess fix will work
      :END:
***** DONE correct org-clock-resolve-idle default time is coming more than thousands
      CLOSED: [2017-12-15 Fri 23:08]
      :LOGBOOK:
      - State "DONE"       from              [2017-12-15 Fri 23:08] \\
        Guess fix will work
...
***** TODO join org-context-clock-task-associated-context-key-fns and org-property-set-functions-alist mean join assoc api with org-property-set-functions-alist
