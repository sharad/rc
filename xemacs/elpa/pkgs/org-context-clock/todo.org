...
*** Advanced
**** When asking task estimate time and the expected datetime when it claimed to be completed,
     do calculate where all other task estimated time and this task estimated will fit into the expected datetime
