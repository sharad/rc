...
***** whether it is subtask of current task or existing task, now required its name
...
**** Hwo related task should get it property by copying or moving etc.
* Tableview
