...
***** define function, so with task heading it will trigger a pre-define action like opening main file in :root directory
***** Trying to remember it should be in basic
*** Obtrusive
