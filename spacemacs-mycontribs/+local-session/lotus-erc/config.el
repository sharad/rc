...
(defun lotus-erc/post-init-erc-config ()
  (progn
      (progn
...
(defun lotus-erc/init-erc-join-config ()
  (progn
    (progn
      (erc-autojoin-mode t))))

(defun lotus-erc/init-erc-services-config ()
  (progn
    (require 'passwds)
    (erc-services-mode 1)
...
(defun lotus-erc/init-erc-nick-notify-config ()
  (progn
      (progn
