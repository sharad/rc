            ...
            (progn
              ...
              (let* ((local-planner-relative-path "web/site/wiki/Organize/plan/Plans")
                     (local-planner-directory
                      (publishing-created-contents-path 'muse local-planner-relative-path))
                ...
                (if (file-directory-p local-planner-directory)
                    (progn
                      (setq
                       ...
                       planner-directory local-planner-directory ;; (expand-file-name local-planner-relative-path *muse-top-dir*)
