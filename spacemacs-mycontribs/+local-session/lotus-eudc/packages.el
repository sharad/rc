...
(defun lotus-eudc/init-eudc ()
  ...
  ;; defined at end
  ;; (setq eudc-protocol 1)
  (use-package eudc
    :defer t
    :commands (message-expand-name eudc-expand-inline lotus-enz-eudc-expand-inline)
    :config
    (progn
      ...
      (progn
        ...
        ;; eudc-protocol
        (message "pre-define eudc-protocol to 1 for loading eudc automatically."))
