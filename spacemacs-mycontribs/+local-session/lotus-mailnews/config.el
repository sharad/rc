...
;;}}
;; from  bindings-config.el
;; from  citation-config.el
...
;; from  color-config.el
;; from  contacts-config.el
...
;; from  gnus-misc-config.el
;; from  gnus-schedule-config.el
...
;; from  mailto-config.el
;; from  message-config.el
...
;; from  nm-config.el
;; from  notification-config.el
;; from  notmuch-config.el
...
(testing
 ...
 (aref x (- (length x ) 1)))
;; from  pers-config.el
;; from  reply-config.el
;; from  search-config.el
;; from  server-config.el
