...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ox-pandoc orgit org-present org-category-capture org-projectile org-brain ob-elixir ob-async elfeed-org org-password-manager org-clock-unnamed-task occ org-plus-contrib org-outlook outlook contentswitch org-onchange gnus-namazu gnus-pers lotus-all lotus-utils p4 project-buffer-mode rcs-backup rs-gnus-exts lotus-tree-manager lotus-basic-utils helm-match-plugin ffw lotus-spacemacs-utils magithub magit-annex lbdb git-annex flx-ido ert-expectations ert-async el-mock agda2-mode ag zen-and-art-theme zeal-at-point yatemplate yaoddmuse yang-mode xterm-color xref-js2 xquery-mode xkcd x86-lookup ws-butler wolfram-mode winum white-sand-theme web-beautify wcheck-mode volatile-highlights vimrc-mode vi-tilde-fringe vala-snippets vala-mode vagrant-tramp vagrant uuidgen utop unicode-fonts unfill underwater-theme uncrustify-mode ujelly-theme twittering-mode twilight-theme twilight-bright-theme twilight-anti-bright-theme ttl-mode treemacs-projectile treemacs-magit transmission toxi-theme toml-mode toc-org thrift thinks term-run term-projectile term-alert tangotango-theme tango-plus-theme tango-2-theme tagedit symon sws-mode sunny-day-theme sublime-themes subatomic256-theme subatomic-theme string-inflection stickyfunc-enhance startup-hooks srefactor sql-indent spray spotify sparql-mode spaceline-all-the-icons spacegray-theme soothe-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smex smeargle slime-company slim-mode shell-pop seti-theme sessions-unified seeing-is-believing scss-mode scad-mode sass-mode salt-mode sailfish-scratchbox rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocopfmt rubocop robe rjsx-mode reverse-theme restclient-helm restart-emacs recentf-ext rebecca-theme reason-mode rcirc-notify rcirc-color rbenv ranger rainbow-identifiers rainbow-delimiters railscasts-theme racer qml-mode pytest pyenv-mode py-isort purple-haze-theme puppet-mode pug-mode protobuf-mode project-root professional-theme prettier-js powershell popup-kill-ring poporg pony-mode pointback play-crystal planet-theme pkgbuild-mode pippel pipenv pip-requirements phpunit phpcbf php-extras php-auto-yasnippets phoenix-dark-pink-theme phoenix-dark-mono-theme persp-mode perl6-mode paths-mapper pastebin password-generator parinfer paradox pandoc-mode package-dev-utils-lotus pabbrev overseer outline-magic orgnav org-snooze org-repo-todo org-randomnote org-pomodoro org-parser org-noter org-mobile-sync org-email org-doing org-dashboard org-context org-clock-table-misc-lotus org-clock-in-if-not org-clock-daysummary org-clock-check org-cliplink org-bullets org-alert opencl-mode open-junk-file omtose-phellack-theme omnisharp oldlace-theme oddmuse ocp-indent occidental-theme obsidian-theme ob-sml ob-ipython ob-hy ob-http ob-crystal ob-coffeescript ob-cfengine3 nov notify nodejs-repl noctilux-theme nlinum-relative nix-mode nginx-mode navi-mode nasm-mode naquadah-theme nameless mwim mvn mustang-theme muse multibackup mu4e-maildirs-extension mu4e-alert moz move-text monokai-theme monochrome-theme molokai-theme moe-theme minitest minimap minimal-theme memory-usage maven-test-mode matlab-mode material-theme markdown-toc majapahit-theme magit-svn magit-gitflow madhat2r-theme macrostep lush-theme lsp-julia lsp-haskell lotus-wrapper lotus-crypt-utils lorem-ipsum logcat livid-mode linum-relative link-hint light-soap-theme less-css-mode kivy-mode jsonnet-mode js2-refactor js-doc jinja2-mode jbeans-theme jazz-theme jade-mode ir-black-theme insert-shebang inf-crystal importmagic import-js impatient-mode ietf-docs idris-mode idomenu ibuffer-projectile hybrid-mode hy-mode hungry-delete hoon-mode hlint-refactor hindent highlight-parentheses highlight-numbers highlight-indentation heroku-theme hemisu-theme helm-themes helm-spotify-plus helm-pydoc helm-purpose helm-projectile helm-pass helm-org-rifle helm-notmuch helm-nixos-options helm-mu helm-mode-manager helm-make helm-hoogle helm-gtags helm-gitignore helm-git-grep helm-flx helm-descbinds helm-dash helm-css-scss helm-cscope helm-company helm-c-yasnippet helm-ag hc-zenburn-theme haskell-snippets gxref gruvbox-theme gruber-darker-theme groovy-imports grandshell-theme gradle-mode google-translate google-c-style godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gmail-message-mode glsl-mode gitignore-templates github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-gutter-fringe git-gutter-fringe+ gist gh-md ggtags geeknote gandalf-theme fuzzy function-args frame-utils forth-mode font-lock+ folding fm flymd flymake-cursor flycheck-ycmd flycheck-rust flycheck-pos-tip flycheck-perl6 flycheck-pact flycheck-package flycheck-ocaml flycheck-nim flycheck-mix flycheck-kotlin flycheck-haskell flycheck-elm flycheck-crystal flycheck-credo flycheck-bashate floobits flatui-theme flatland-theme fish-mode feature-mode faust-mode fasd farmhouse-theme fancy-battery fakir eziam-theme eyebrowse expand-region exotica-theme evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-numbers evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-escape evil-ediff evil-cleverparens evil-args evil-anzu evernote-mode ess-R-data-view espresso-theme esh-help ertx ert-runner ert-modeline ert-junit erc-view-log erc-social-graph erc-hl-nicks eproject ensime emoji-cheat-sheet-plus emmet-mode ember-yasnippets elm-test-runner elisp-slime-nav elfeed-goodies edit-server ediprolog ecb ebuild-mode dune drupal-mode dpaste dotnet dockerfile-mode django-theme disaster diminish diff-hl dhall-mode devdocs deft define-word debug-info dart-server dart-mode darktooth-theme darkokai-theme darkmine-theme darkburn-theme dap-mode dante dakrone-theme dactyl-mode d-mode cython-mode cyberpunk-theme cuda-mode csv-mode cquery cpp-auto-include counsel-org-clock counsel-etags corral copy-as-format confluence conda company-ycmd company-web company-terraform company-tern company-statistics company-shell company-rtags company-restclient company-reftex company-plsense company-php company-nixos-options company-lua company-lsp company-go company-ghci company-ghc company-emoji company-dcd company-coq company-cabal company-c-headers company-auctex company-ansible company-anaconda common-lisp-snippets command-log-mode column-enforce-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized color-theme-modern color-identifiers-mode coffee-mode cmm-mode cmake-mode cmake-ide clues-theme clojure-snippets clean-aindent-mode clang-format cider-eval-sexp-fu cider chruby chocolate-theme cherry-blossom-theme centered-cursor-mode ccls cargo calfw-org calfw-cal calfw c-eldoc busybee-theme bundler buffer-utils bubbleberry-theme browse-at-remote bm blacken bitlbee birds-of-paradise-plus-theme badwolf-theme autoinsert+ auto-highlight-symbol auto-dictionary auto-complete-rst auto-compile attrap arjen-grey-theme arduino-mode apropospriate-theme aok anti-zenburn-theme ansible-doc ansible annotate ample-zen-theme ample-theme ameba alect-themes alda-mode alchemist ahk-mode aggressive-indent afternoon-theme adoc-mode activity achievements ace-popup-menu ace-jump-helm-line academic-phrases ac-ispell)))
