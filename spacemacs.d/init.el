...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yas-suggest tagging paths-mapper lotus-notify lotus-basic-utils iswitchb-fc ffw ff-relativedir emacs-panel echoserver copywithoutsel planner-utils pa-planner emacs-db-mode academic-phrases counsel-etags counsel ggtags reader-mode timer-utils-lotus org-onchange publishing project-buffer-file org-misc-utils-lotus org-clock-wrapper rcs-backup zenburn-theme winum w3m use-package toc-org test-session tao-theme startup-hooks sessions-unified pip-requirements paradox package-dev-utils-lotus org-scahachua org-mime org-context-clock org-clock-utils-lotus neotree mwim live-py-mode inkpot-theme highlight-numbers helm-make gruvbox-theme go-guru git-timemachine git-link ghub find-file-in-project evil-surround evil-matchit espresso-theme dumb-jump deft darkokai-theme counsel-projectile company-anaconda color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized outshine ox-pandoc org-category-capture org-password-manager org-brain elfeed-org projectile-rails geeknote feature-mode ahk-mode helm-gtags helm-cscope ivy-xref counsel-gtags function-args gxref lotus-utils xref-js2 sws-mode calfw-org calfw-cal mindshare-contrib-mgr clipmon occ counsel-org-clock timesheet task-manager orgit org-present ob-elixir org-projectile org-plus-contrib stickyfunc-enhance yaoddmuse uncrustify-mode srefactor oddmuse lotus-wrapper org-onchnage org-clock-unnamed-task org-clock-in-if-not org-clock-hooks org-clock-experimental org-clock-check org-capture+ lotus-misc-utils org-doing htmlize zen-and-art-theme yapfify yaml-mode xterm-color xquery-mode xcscope ws-butler white-sand-theme wgrep web-beautify wcheck-mode wakatime-mode volatile-highlights vi-tilde-fringe uuidgen unfill underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme thinks tangotango-theme tango-plus-theme tango-2-theme tagedit sunny-day-theme sublime-themes subatomic256-theme subatomic-theme spacegray-theme soothe-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smex smeargle slim-mode shell-pop seti-theme scss-mode sass-mode reverse-theme restart-emacs remember-unified remember-idle recentf-ext rebecca-theme rainbow-identifiers rainbow-delimiters railscasts-theme pytest pyenv-mode py-isort purple-haze-theme pug-mode project-root professional-theme popup-kill-ring pointback planet-theme phoenix-dark-pink-theme phoenix-dark-mono-theme persp-mode pcre2el pastebin pabbrev outline-magic origami organic-green-theme org-pomodoro org-download org-clock-table-misc-lotus org-clock-resolve-advanced org-clock-daysummary org-bullets org-agenda-refiletarget-files-filters open-junk-file omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme next-package naquadah-theme mustang-theme muse multibackup multi-term moz move-text monokai-theme monochrome-theme molokai-theme moe-theme mmm-mode minimap minimal-theme material-theme markdown-toc majapahit-theme magit-gitflow madhat2r-theme macrostep lusty-explorer lush-theme lotus-crypt-utils lorem-ipsum livid-mode linum-relative light-soap-theme less-css-mode json-mode js2-refactor js-doc jbeans-theme jazz-theme jade-mode ivy-hydra ir-black-theme indent-guide idomenu hy-mode hungry-delete highlight-parentheses highlight-indentation heroku-theme hemisu-theme helm-themes helm-swoop helm-pydoc helm-mode-manager helm-gitignore helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag hc-zenburn-theme gruber-darker-theme grandshell-theme gotham-theme google-translate golden-ratio go-eldoc gnuplot gitconfig-mode gitattributes-mode git-messenger git-gutter-fringe git-gutter-fringe+ gh-md gandalf-theme fuzzy frame-utils folding fm flyspell-correct-helm flymake-cursor flycheck-pos-tip flycheck-mix flycheck-credo flx-ido flatui-theme flatland-theme fill-column-indicator farmhouse-theme fancy-battery eyebrowse expand-region exotica-theme exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-magit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help erlang eproject emmet-mode elisp-slime-nav ecb dracula-theme dpaste django-theme disaster diminish diff-hl define-word darktooth-theme darkmine-theme darkburn-theme dakrone-theme d-mode cython-mode cyberpunk-theme corral company-web company-tern company-statistics company-go company-dcd column-enforce-mode color-identifiers-mode coffee-mode clues-theme clean-aindent-mode cherry-blossom-theme calfw c-eldoc busybee-theme buffer-utils bubbleberry-theme bm bitlbee birds-of-paradise-plus-theme badwolf-theme autoinsert+ auto-highlight-symbol auto-dictionary auto-compile apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes alchemist aggressive-indent afternoon-theme adaptive-wrap activity ace-window ace-link ace-jump-helm-line ac-ispell zoutline outorg navi-mode persp-mode-projectile-bridge poporg orgnav worf @)))
 '(planner-xhtml-footer "<lisp>(muse-insert-meta-file \"footer.html\")</lisp>")
 '(planner-xhtml-header "<lisp>(muse-insert-meta-file \"header.html\")</lisp>")
